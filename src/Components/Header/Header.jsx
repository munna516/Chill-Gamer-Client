...
const Header = () => {
  ...
  return (
    <>
      <div className="navbar w-11/12 mx-auto h-20 p-0">
        ...
        <div className="navbar-end gap-3">
          {user && user?.email ? (
            <div className="flex items-center gap-5">
              <div
                className="lg:tooltip lg:tooltip-open lg:tooltip-bottom cursor-pointer"
                data-tip={user?.displayName}
              >
                <img
                  className="w-14 rounded-full border-2 p-1"
                  src={user?.photoURL}
                  alt=""
                />
              </div>
